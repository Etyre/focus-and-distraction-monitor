...
* A **focused task span** is a special kind of focus span, in which my attention is focused on executing on tasks, but I’m   
  * Discerning the difference between this and distraction, or just doing tasks in a more lackadaisical and less focused way requires judgement.  
  * Some heuristics:   
    ...
    * When doing focused task processing, I’ll almost always have a toggl entry running (or possibly a series of toggl entries).  
